...
func initConfig() {
	...
	viper.SetDefault("revocation.enabled", true)
	viper.SetDefault("revocation.refresh_interval", "12h")
	viper.SetDefault("ratelimit.enabled", false)
	viper.SetDefault("ratelimit.requests_per_second", 1.0)
	...
	_ = viper.BindEnv("revocation.enabled", "ATTESTATION_SERVER_REVOCATION_ENABLED")
	_ = viper.BindEnv("revocation.refresh_interval", "ATTESTATION_SERVER_REVOCATION_REFRESH_INTERVAL")
	_ = viper.BindEnv("ratelimit.enabled", "ATTESTATION_SERVER_RATELIMIT_ENABLED")
	_ = viper.BindEnv("ratelimit.requests_per_second", "ATTESTATION_SERVER_RATELIMIT_REQUESTS_PER_SECOND")
